            ...
            <div class="row justify-content-between">
                ...
                <div class="card mb-4 col-12 col-sm-7 col-md-12 ml-auto">
                    ...
                    <table class="table table-bordered table-captura-ventas" width="100%" style="margin-top: 12px;">
                        <tbody>
                            <tr id="recibo_anticipo_disp_view" style="display: none; background-color: #0bb19e;">
                                <td><h6 style="margin-bottom: 0px; font-size: 0.9rem; font-weight: 500; color: white;">ANTICIPOS DISP: </h6></td>
                                <td><h6 style="margin-bottom: 0px; float: right; font-size: 0.9rem; color: white;" id="recibo_anticipo_disp">0.00</h6></td>
                            </tr>
                            <tr>
