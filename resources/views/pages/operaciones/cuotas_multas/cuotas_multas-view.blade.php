                    ...
                    <div class="card">
                        <div class="row" style="padding: 4px;">
                            <div class="form-group col-4 col-sm-4 col-md-4" >
                                ...
                                <input type="date" class="form-control form-control-sm" name="fecha_desde_cuotas_multas" id="fecha_desde_cuotas_multas">
                            </div>

                            <div class="form-group col-4 col-sm-4 col-md-4" >
                                <label for="example-text-input" class="form-control-label">Fecha hasta</label>
                                <input type="date" class="form-control form-control-sm" name="fecha_hasta_cuotas_multas" id="fecha_hasta_cuotas_multas">
                            </div>
