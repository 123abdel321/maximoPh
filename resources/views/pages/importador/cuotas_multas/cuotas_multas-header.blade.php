    ...
    <div class="accordion-item">
        ...
        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="filtrosCuotasExtrasImport" data-bs-parent="#accordionRental" >
            <div class="accordion-body text-sm" style="padding: 0 !important;">
                ...
                <button id="actualizarPlantillaCuotasExtras" href="javascript:void(0)" class="btn btn-sm badge bg-gradient-primary" style="float: right; display: none; margin-top: -40px; position: relative;">
