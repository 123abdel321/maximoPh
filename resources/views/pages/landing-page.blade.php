                        ...
                        <div class="container-xl">
                            ...
                            <div class="d-flex js-build-in-trigger position-relative" data-build-in-stagger="100">
                                ...
                                <div class="col-11 col-lg-8 ml-2 ml-md-0 mb-6 mb-md-10 pr-lg-3">
                                    ...
                                    <h2 class="h3-mktg mb-4 text-medium js-build-in-item build-in-slideX-left"
                                        style="transition-delay: 300ms;">
                                        <span class="text-accent-primary d-block">+57 318 3899 872</span>
                                    </h2>
                                </div>
                ...
                <div class="container-xl p-responsive f6 py-4 d-md-flex flex-justify-between flex-items-center">
                    ...
                    <nav aria-label="GitHub's Social Media Links" class="mt-3 mt-md-0">
						<ul class="list-style-none d-flex flex-items-center lh-condensed-ultra" style="cursor: pointer;" onclick="openWhatSapp()">
							...
							<span class="mb-3 mb-md-0">318 3899 872</span>
						</ul>
                        <!-- <ul class="list-style-none d-flex flex-items-center lh-condensed-ultra">
                            <li class="ml-md-3" style="cursor: pointer;" onclick="openWhatSapp()">
								<div class="eqA2re UnOTSe Vwoesf" aria-hidden="true">
									<img class="XNo5Ab" src="data:image/png;base64," style="height:26px;width:26px" alt="" data-csiid="8" data-atf="1">
								</div>
								<span class="mb-3 mb-md-0">+57 318 3899 872</span>
                            </li>
                            <li class="ml-3">
