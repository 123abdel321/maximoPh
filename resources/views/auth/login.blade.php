                            ...
                            <div class="card card-plain">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="flex flex-col mb-3">
                                        <input type="email" id="email_login" name="email" class="form-control form-control-lg" value="andres@cartagena.com" aria-label="Email" placeholder="Correo">
                                        @error('email') <p class="text-danger text-xs pt-1"> {{$message}} </p>@enderror
                                    </div>
                                    <div class="flex flex-col mb-3">
                                        <input type="password" id="password_login" name="password" class="form-control form-control-lg" aria-label="Password" value="554245" onkeypress="changePassWord(event)" placeholder="Contraseña">
