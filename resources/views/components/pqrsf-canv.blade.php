<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header offcanvas-header-maximo">
        <img id="offcanvas_header_img" class="offcanvas-header-img" src="/img/no-photo.jpg" class="img-thumbnail" alt="...">
    ...
    <div id="estado_en_mensaje_pqrsf" class="item-estado-pqrsf-chat pqrsf-chat-activo">Activo</div>

    <div id="offcanvas-body-pqrsf" class="offcanvas-body wrapper" style="contain: content; border-top: solid 1px #dddddd;">
        ...
        <form id="form-pqrsf-mensajes" class="modal-content" enctype="multipart/form-data" style="border: solid 0px;">
            ...
            <div class="add-time-pqrsf" style="padding: 12px; border-top: solid 1px #e5e5e5; text-align: center; display: none;">
                ...
                <div class="row" style="align-items: center;">
                    <div class="col-2">
                        <div id="iniciar-tiempo-pqrsf" style="cursor: pointer; width: 25px; height: 25px; background-color: #00ca00; color: white; border-radius: 50%; box-shadow: 0px 0px 0px rgba(50, 50, 93, 0.1), 3px 3px 2px rgb(0 0 0 / 57%); display: none;" onclick="guardarTiempoPqrsf(true)">
                            <i class="fas fa-play" style="position: absolute; margin-top: 8px; margin-left: -4px;"></i>
                        </div>
                        <div id="detener-tiempo-pqrsf" style="cursor: pointer; width: 25px; height: 25px; background-color: #ca0000; color: white; border-radius: 50%; box-shadow: 0px 0px 0px rgba(50, 50, 93, 0.1), 3px 3px 2px rgb(0 0 0 / 57%); display: none;" onclick="guardarTiempoPqrsf(false)">
            ...
            <div id="row-actios-pqrsf" class="row actions-pqrsf">
                ...
                <div id="content-button-status-pqrsf" class="col-1 content-button-status-pqrsf">
                    <div id ="content-button-change-status" class="button-change-status" onclick="changeEstadoPqrst()">
                        <i id="content-button-change-status-iconNormal" style="position: relative; top: 42%; transform: translateY(-50%); margin-left: 4px; -webkit-transform: translateY(-50%); cursor: pointer;" class="fas fa-edit"></i>
                        <i id="content-button-change-status-iconLoading"style="position: relative; top: 30%; transform: translateY(-50%); margin-left: 4px; -webkit-transform: translateY(-50%); cursor: pointer; display: none;" class="fas fa-spinner fa-spin"></i>
                    </div>
                </div>
                <!-- BOTON AGREGAR TIEMPO -->
                <div id="content-button-time-pqrsf" class="col-1 content-button-status-pqrsf" style="display: none;">
                    <div id ="content-button-change-time" class="button-change-status" onclick="addTimePqrst()">
                        <i id="content-button-add-time-iconNormal" style="position: relative; top: 42%; transform: translateY(-50%); margin-left: 5px; -webkit-transform: translateY(-50%); cursor: pointer;" class="fas fa-stopwatch"></i>
                ...
                <div id="content-button-time-pqrsf-disabled" class="col-1 content-button-status-pqrsf" style="cursor: no-drop;">
                ...
                <div class="col-1 content-send-pqrsf">
                    ...
                    <div id="button-send-pqrsf-loading" class="button-send-pqrsf" style="display: none;">
