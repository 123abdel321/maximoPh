...
<head>
    ...
    <!-- FILEPOND -->
    <link rel="stylesheet" href="assets/css/plugins/filepond.css" rel="stylesheet" />
    <link rel="stylesheet" href="assets/css/plugins/filepond-plugin-image-preview.min.css" rel="stylesheet" />
    <link rel="stylesheet" href="assets/css/plugins/filepond-plugin-file-poster.min.css" rel="stylesheet" />
...
<body class="body-basic" style="background-color: #060e26;">
    ...
    <script src="assets/js/plugins/perfect-scrollbar.min.js"></script>
    <!-- TURNOS -->
    <script src="assets/js/sistema/turnos-generales.js?v={{ config('app.version') }}" rel="stylesheet"></script>
    <!-- FILEPOND -->
    <!-- <script src="assets/js/plugins/pintura.js"></script> -->
    <script src="assets/js/plugins/filepond.js"></script>
    <script src="assets/js/plugins/filepond-plugin-image-transform.min.js"></script>
    <script src="assets/js/plugins/filepond-plugin-image-resize.min.js"></script>
    <script src="assets/js/plugins/filepond-plugin-image-preview.min.js"></script>
    <script src="assets/js/plugins/filepond-plugin-image-editor.min.js"></script>
