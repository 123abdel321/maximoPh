...
Route::get('/phpinfo_acartaca', function (Request $request) {
	...
	$parameters = [
		...
		"3" => "FAC 2025-01",
		"4" => "maximo/empresas/25/pdf/factura_677d9bccb8b52.pdf"
	];

	$whatsapp = new SendTwilioWhatsApp($contentSid, $to, $parameters);
...
Route::group(['middleware' => ['auth:sanctum']], function () {
	...
	Route::group(['middleware' => ['clientconnectionweb']], function () {
		...
		Route::get('/facturacion-multiple', [FacturacionController::class, 'showMultiplePdf']);
