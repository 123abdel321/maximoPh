...
!function(e) {
    e.fn.imageUploader = function(t) {
        let n, i = {
            ...
            label: "Arrastre y suelte archivos aquí o haga clic para explorar",
        ...
        let o = function() {
          ...
          , g = function(e) {
            return !(a.settings.extensions.indexOf(e.name.replace(new RegExp("^.*\\."), ".")) < 0) || agregarToast('error', 'Imagen error', `The file "${e.name}" exceeds the maximum size of ${a.settings.maxSize / 1024 / 1024}Mb`)
        }
          , c = function(e) {
            return !(a.settings.mimes.indexOf(e.type) < 0) || agregarToast('error', 'Imagen error', `The file "${e.name}" exceeds the maximum size of ${a.settings.maxSize / 1024 / 1024}Mb`)
        }
          , f = function(e) {
            return !(e.size > a.settings.maxSize) || agregarToast('error', 'Imagen error', `The file "${e.name}" exceeds the maximum size of ${a.settings.maxSize / 1024 / 1024}Mb`)
        }
          , m = function(e, t) {
            return !(e + s.items.length + a.settings.preloaded.length >= a.settings.maxFiles) || agregarToast('error', 'Imagen error', `The file "${e.name}" exceeds the maximum size of ${a.settings.maxSize / 1024 / 1024}Mb`)
        }
          , u = function(t, n) {
