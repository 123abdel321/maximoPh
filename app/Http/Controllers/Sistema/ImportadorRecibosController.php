                ...
                foreach ($recibosImport as $reciboImport) {
                    ...
                    foreach ($extractos as $extracto) {
                        ...
                        $doc = new DocumentosGeneral([
                            ...
                            "documento_referencia" => $cuentaPago->exige_documento_referencia ? $this->consecutivo : null,
                    ...
                    if ($valorDisponible > 0) {
                        ...
                        $doc = new DocumentosGeneral([
                            ...
                            "documento_referencia" => $cuentaAnticipo->exige_documento_referencia ? $this->consecutivo : null,
                    ...
                    $doc = new DocumentosGeneral([
                        ...
                        'documento_referencia' => $this->consecutivo,
